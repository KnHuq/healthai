...
const Analysis = () => {
  ...
  const fetchLinechartData = async (date) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/linechart_data?date=${formattedDate}`
      );
      if (!response.ok) {
  ...
  const fetchBarchartData = async (date) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/barchart_data?date=${formattedDate}`
      );
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
  ...
  const fetchSimpletableData = async (date) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/simpletable_data?date=${formattedDate}`
      );
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
